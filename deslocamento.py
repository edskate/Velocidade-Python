...
velocidade_inicial_ms = velocidade_inicial_mph * (1000 / 3600)  # 1 mph = 1000 m/3600 s

# Calculando a velocidade final
velocidade_final_ms = velocidade_inicial_ms + (aceleracao_media_ms2 * tempo_segundos)
